...
export const postsData = [
  {
    ...
    description: "Hurry up and register for your favorite events. Limited slots available for some events.",
  ...
  },
  {
    ...
    description: "Exciting announcement! We have a renowned tech entrepreneur who will be speaking at the fest.",
    image: "https://images.unsplash.com/photo-1475721027785-f74fcb76e293?w=500&h=300&fit=crop",
    date: "February 12, 2025"
  },
  {
    id: 3,
    title: "Accommodation and Transport Details",
    description: "Complete information about accommodation, bus picks from major cities and on-campus transportation.",
  ...
  },
  {
    ...
    description: "Check out the complete schedule of all events happening across the 3 days of the fest.",
...
export const eventCategories = [
  { name: "Technical", icon: "💻", count: 3 },
  { name: "Non-Technical", icon: "🛠️", count: 2 },
  { name: "Flash Mob", icon: "💃🕺", count: 2 },
  { name: "Sports", icon: "⚽", count: 1 },
  { name: "Cult Night", icon: "🎆", count: 1 }
];
